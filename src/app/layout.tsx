    ...
    },
    {
      ...
      hasPart: [
        ...
        },
        {
          ...
          description: "Transparent pricing in ZAR for web design, AI solutions, cybersecurity and retainers",
        },
        {
          "@type": "WebPage",
          name: "How We Work",
          url: `${SITE_URL}/process`,
          description: "Our 7-step process from discovery call to live launch in 21 days",
        },
        {
          "@type": "WebPage",
          name: "FAQ",
          url: `${SITE_URL}/faq`,
          description: "Frequently asked questions about working with Thannlab",
        },
      ],
      inLanguage: "en-ZA",
    },
